...
<body>
            ...
            <div class="bd-example">
                <div id="carouselOne" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item bg_cover active" style="background-image: url(landp/assets/images/slider-1.jpg)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Sistem Tes Minat dan Bakat</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <li><a class="main-btn rounded-three" a href="{{ route('login') }}">LOG IN</a></li>
                                                <li><a class="main-btn rounded-one" a href="{{ route('register') }}">SIGN UP</a></li>
                                            </ul>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.2s">
                        <div class="about-icon">
                            <img src="landp/assets/images/icon-1.png" alt="Icon">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.4s">
                        <div class="about-icon">
                            <img src="landp/assets/images/icon-2.png" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                ...
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.6s">
                        <div class="about-icon">
                            <img src="landp/assets/images/icon-3.png" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                ...
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.8s">
                        <div class="about-icon">
                            <img src="landp/assets/images/icon-4.png" alt="Icon">
                        </div>
                        <div class="about-content media-body">
                ...
                <div class="col-lg-12">
                    <div class="row testimonial-active">
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src="landp/assets/images/author-3.jpg" alt="Author">
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src="landp/assets/images/author-1.jpg" alt="Author">
                                </div>
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src="landp/assets/images/author-2.jpg" alt="Author">
                                </div>
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src="landp/assets/images/author-4.jpg" alt="Author">
                                </div>
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="copyright text-center text-lg-left mt-10">
                            <p class="text"> © 2023 by Wahyu Nandira B. </p>
                        </div> <!--  copyright -->
                    </div>
                    </div>
                </div> <!-- row -->
    ...
    <!--====== jquery js ======-->
    <script src="landp/assets/js/vendor/modernizr-3.6.0.min.js"></script>
    <script src="landp/assets/js/vendor/jquery-1.12.4.min.js"></script>

    <!--====== Bootstrap js ======-->
    <script src="landp/assets/js/bootstrap.min.js"></script>
    <script src="landp/assets/js/popper.min.js"></script>

    <!--====== Slick js ======-->
    <script src="landp/assets/js/slick.min.js"></script>

    <!--====== Isotope js ======-->
    <script src="landp/assets/js/isotope.pkgd.min.js"></script>

    <!--====== Images Loaded js ======-->
    <script src="landp/assets/js/imagesloaded.pkgd.min.js"></script>

    <!--====== Magnific Popup js ======-->
    <script src="landp/assets/js/jquery.magnific-popup.min.js"></script>

    <!--====== Scrolling js ======-->
    <script src="landp/assets/js/scrolling-nav.js"></script>
    <script src="landp/assets/js/jquery.easing.min.js"></script>

    <!--====== wow js ======-->
    <script src="landp/assets/js/wow.min.js"></script>

    <!--====== Main js ======-->
    <script src="landp/assets/js/main.js"></script>
